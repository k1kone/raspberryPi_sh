...
from k_dic import k_dic #LCDデバイス　カタカナ表記用
...
class acm1602:
    ...
    def write(self,buf):
        ...
        while i < length:
            ...
            self.i2c.write_byte_data(self.ad,0x80,self.kanaConv(buf[i])) #LCDデバイス　カタカナ表記用
    ...
    def kanaConv(self, char_date):
        result = ord(char_date)
        return result
